...
%% Título: Análise Visual (Visual Analytics) de Topologia e Texto em Redes Sociais
%% ou Analítica(s) Visual(is). Analítica como substantivo aparece nos dicionários somente como abreviação de Geometria Analítica
%% Analítica(o) parece ser só adjetivo no português, mas pode-se substantivar o adjetivo.
%% exceção: https://www.infopedia.pt/dicionarios/lingua-portuguesa/anal%C3%ADtica http://www.aulete.com.br/anal%C3%ADtica (brecha!?)
...
%% Citar literatura e software relacionados, livres e proprietários
...
%% Dinâmica de jogos também para aumentar o interesse do usuário
...
%% Muitas implementações para testar, livres e proprietárias.
%% Muitas áreas involvidas: cognição, estética, HCI, aprendizado de máquina, programação, estruturas sociais, mineração de texto
%% fora a literatura dedicada a visual analytics e visualização de dados
%% Quantidade massiva de dados. Usar WebGL e ter opções coarsed e de renderização de imagens estáticas para casos extremos
