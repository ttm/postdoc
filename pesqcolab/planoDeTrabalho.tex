...
\title{Analítica Visual (Visual Analytics) para processos de difusao em redes complexas}
...
Este projeto propõe o desenvolvimento de métodos e software de analítica visual (\emph{visual analytics}) para processos de difusao em redes complexas.
...
\noindent\\
\textbf{Palavras-chave:} Analitica visual, Redes sociais, Redes complexas, Mineração de texto.
...
\setcounter{page}{1}
% formulação do problema, objetivo, justificativa, metodologia e cronograma de execução
...
Tais fontes incluem MOOCs\footnote{a}, software\footnote{graphology, networkx}, assinatura e contribuicoes em paginas da Wikipedia\footnote{\url{https://en.wikipedia.org/wiki/Network-based_diffusion_analysis}},
...
e.g. \emph{Network Dynamics of Social Behavior} (\url{https://www.coursera.org/learn/networkdynamics/home/welcome}), este segmento do \emph{Social and Economic Networks: Models and Analysis} (\url{https://www.coursera.org/lecture/social-economic-networks/5-1-diffusion-Od7yv}).
Ha varios materiais (inclusive MOOCs) excelentes e relevantes para este trabalho, por exemplo intro ao NetLogo Complexity explorer\footnote{\url{https://www.complexityexplorer.org/}}.
...
Este eh o numero minimo de horas semanais previstas na Resolução CoPq Nº 7413.
...
\subsection{Artigos}
Redes adaptativas melhores com estrategia de difusao do que por consenso~\cite{adapt}.

Estimacao de influencia em redes de difusao em tempo continuo: algoritmo menos caro, aplicacao, usa sementes~\cite{diffusionInfluence}.

Arcabouco unificado para redes de difusao: doencas infecciosas, processos economicos e sociais, com foco na semelhanca encontrada para difusao online~\cite{structure}. Autores excelentes.

Contagio simples e complexo, tratamento matematico. Usa sementes mas nao chama de sementes~\cite{simpleComplex}.

Arqueologia da difusao para reconstrucao do historico da progressao~\cite{archeology}.

Inferencia de links e taxa de trasmissao em redes de difusao atraves de cascatas de estados dos vertices~\cite{inferencia}.

Estimacao e otimizacao de influencia em redes de difusao em tempo continuo~\cite{estimaOtimiza}.

Esparsidade promovendo controle otimo de consenso e sincronizacao~\cite{consensoSync}.

Sincronizacao de redes cerebrais quando em descanso~\cite{redeCerebral}.

\subsection{Wikipedia}
Difusao de informacao, cita redes em aspectos bem definidos, mas nao tem uma soh figura de rede, pode ter informacao valiosa para novos modelos e visualizacoes: \url{https://en.wikipedia.org/wiki/Diffusion_of_innovations}.

Redes de sincronizacao~\url{https://en.wikipedia.org/wiki/Synchronization_networks}.

\subsection{Extra}
Possibilita paralelos com os experimentos jah realizados
a criacao de modelos parametrizados com os conceitos apresentados:
\url{https://www.slideshare.net/kevinstrowbridge/diffusion-of-innovations-overview?next_slideshow=1}.

Verbete em handbook da Oxford sobre redes de difusao: \url{https://www.oxfordhandbooks.com/view/10.1093/oxfordhb/9780199948277.001.0001/oxfordhb-9780199948277-e-11}.

\emph{STRUCTURE AND DYNAMICS OF DIFFUSION NETWORKS}, tese de doutorado em filosofia \url{https://people.mpi-sws.org/~manuelgr/pubs/thesis-manuelgr-final.pdf}.
